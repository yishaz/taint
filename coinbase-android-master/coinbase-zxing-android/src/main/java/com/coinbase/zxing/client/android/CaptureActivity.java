...
public final class CaptureActivity extends Activity implements SurfaceHolder.Callback {
  ...
  public void onCreate(Bundle icicle) {
    ...
    // Lock orientation because runtime orientation changes are not supported.
  ...
  public void finish() {
    super.finish();
    overridePendingTransition(R.anim.barcode_stop_enter, R.anim.barcode_stop_exit);
  }
  ...
  protected void onResume() {
    ...
    // Play animation
    overridePendingTransition(R.anim.barcode_start_enter, R.anim.barcode_start_exit);
