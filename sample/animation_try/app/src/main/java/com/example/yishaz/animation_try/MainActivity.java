...
package com.example.yishaz.animation_try;
...
import com.example.yishaz.animation_try.R;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        thumb1View.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                zoomImageFromThumb(thumb1View, R.drawable.homepage_sports_pic);
            }
        });
        ...
        thumb2View.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                zoomImageFromThumb(thumb2View, R.drawable.post_my);
            }
        });
